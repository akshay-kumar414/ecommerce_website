...
mongoose.connect(process.env.MONGO_URI)
  .then(async () => {
    ...
    await User.insertMany([
      {
        _id: new mongoose.Types.ObjectId("69abec2f1960e91d42145757"),
        name: "Demo Customer",
        email: "customer@localkart.dev",
        password: demoPassword,
        role: "customer"
      },
      {
        _id: new mongoose.Types.ObjectId("69ae9f9985f986540238ec6f"),
        name: "Demo Admin",
        email: "admin@localkart.dev",
        password: demoPassword,
        role: "admin"
      }
    ]);
